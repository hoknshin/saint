...
opt = compose(config_name="reproduce_semi")
...
print (f'''X_train.shape, y_train.shape : {X_train['data'].shape}, {y_train['data'].shape}''')
print (f'''X_valid.shape, y_valid.shape : {X_valid['data'].shape}, {y_valid['data'].shape}''')
print (f'''X_test.shape, y_test.shape : {X_test['data'].shape}, {y_test['data'].shape}''')
